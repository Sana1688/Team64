...
//Doctor order prescription Scenes
...
public class DoctorPerscriptions {
	...
	public HBox createDoctorPerscriptions()
	{
        ...
        TableView perscriptionsOrderTable = new TableView(); //table of doctors order history
        ...
        orderPerscriptionButton = new Button("Order Perscription");//button for ordering prescription
