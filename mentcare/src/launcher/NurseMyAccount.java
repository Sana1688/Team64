...
//	
		...
		DatePicker dobPatientCalendar = new DatePicker(); //date picker for DOB
				dobPatientCalendar.setMaxSize(125, 25);
				
		Label genderPatient = new Label("Gender");
		TextField genderPatientDrop = new TextField();//gender textfield
		...
		TextField emailText = new TextField(); //add email
		...
		TextField pharmacyField = new TextField(); //add pharmacy
