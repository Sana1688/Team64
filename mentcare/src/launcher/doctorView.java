...
//Doctors Update Information Scene
...
//	
		...
		TextField firstNameField = new TextField(); //first name textfield
		
		Label lastNameLabel = new Label("Last Name");
		TextField lastNameField = new TextField();// last name textfield
		
		Label dobPatient = new Label("Date of Birth");
		DatePicker dobPatientCalendar = new DatePicker(); //date of birth pciker
				dobPatientCalendar.setMaxSize(125, 25);
				
		Label genderPatient = new Label("Gender");
		TextField genderPatientDrop = new TextField(); //gender field
		...
		TextField PhoneNumberText = new TextField(); //phone number text field
		
		Label emailLabel = new Label("Email:");
		TextField emailText = new TextField(); //email text field
		
		GridPane contactGrid = new GridPane();
		
		contactGrid.add(PhoneNumberLabel, 0, 0, 1, 1);
		contactGrid.add(PhoneNumberText,  1, 0, 1, 1);
		...
		contactGrid.setMargin(PhoneNumberLabel, new Insets(5, 0, 0, 10));
		contactGrid.setMargin(PhoneNumberText, new Insets(5, 0, 0, 10)); 
		...
		TextField pharmacyField = new TextField(); //add pharmacy text field (probably not necessary)
		...
		Button saveChangesButton = new Button("Save Changes"); //save changes button
