...
public class NurseAddInfo {
	...
	public ScrollPane createNurseAddInfo()
	{
	    ...
	    TextField patientNameTextField = new TextField(); //patient name textfield
	    
	    Label weightLabel = new Label("Weight:");
	    TextField weightTextField = new TextField();// weight text field
	    
	    Label heightLabel = new Label("Height:");
	    TextField heightTextField = new TextField();//height textfield
	    
	    Label temperatureLabel = new Label("Temperature:");
	    TextField temperatureTextField = new TextField();//temperature textfield
	    
	    Label bloodPressureLabel = new Label("Blood Pressure:");
	    TextField bloodPressureTextField = new TextField(); //blood pressure textfield
	    bloodPressureTextField.setPrefWidth(50);

	    
	    Label allergensLabel = new Label("Allergens:");
	    TextArea allergensTextField = new TextArea(); //allergens text area
	    allergensTextField.setPrefWidth(50);
	    allergensTextField.setPrefHeight(30);

	    
	    Label otherLabel = new Label("Other Info:"); //other info text area
	    ...
	    Button addInfoUpdateButton = new Button("Update Information");//update information button
