...
public class mssgGUI {
	...
	{//navigation buttons
        ...
        TextField toTextField = new TextField("");// Send to text field
        
        Label subjectLabel= new Label("Subject: ");
        TextField subjectTextField = new TextField("");// subject of message text field
        ...
        TextArea messageContent = new TextArea(""); //textarea for message content
